...
export const TopPglist = [
    {
        price: 6500,
        description: "This Co-living PG is in Mohyal Colony(gated society), which has more than 2 Gyms, 4 Parks - less pollution, more greenery & safety",
        image: "/pg data/WhatsApp Image 2025-07-09 at 19.49.38_6c291a3a.jpg",
        facilities: [
            FaWifi, FaRegSnowflake, FaDumbbell, CgSmartHomeRefrigerator
        ]
    },
    {
        price: 6500,

...
import { useCallBack } from '../viewmodels/useCallBack';

export const CallBackModal = ({ isOpen, onClose, pgName }) => {
  const {submitted , handleOnChange , tenentDetails , handleSubmit} = useCallBack( onclose );
  return (
    <AnimatePresence>
      {isOpen && (
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        type="text"
                        name='full_name'
                        value={tenentDetails.full_name}
                        onChange={handleOnChange}
                        placeholder="John Doe"
                        className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-2 focus:ring-orange-500 outline-none transition-all" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        type="email"
                        name='email'
                        value={tenentDetails.email || ''}
                        onChange={handleOnChange}
                        placeholder="john@example.com" className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-2 focus:ring-orange-500 outline-none transition-all" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        type="tel"
                        name='phone'
                        value={tenentDetails.phone || ''}
                        onChange={handleOnChange}
                        placeholder="+91 98765 43210" className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-2 focus:ring-orange-500 outline-none transition-all" />
                    </div>
                  </div>

                  <button onClick={handleSubmit} className="w-full bg-slate-900 text-white font-bold py-4 rounded-2xl hover:bg-orange-600 transition-all flex items-center justify-center gap-2 mt-4 shadow-lg shadow-slate-200">

...
const Signup = () => {
    const {
        ...
        handleInputChange, handleSignup, loading
    } = useSignup();
                    ...
                    <div className="space-y-8">
                        ...
                        <ul className="space-y-4">
                            {[
                                ...
                                "Zero-hassle digital contracts",
                                "Instant communication with owners"
                            ].map((text, i) => (
                                <motion.li
            ...
            <div className="w-full max-h-screen lg:w-1/2 flex items-center justify-center p-8 md:p-16 bg-slate-50">
                ...
                >
                    ...
                    <p className="mt-6 text-center text-slate-500 font-medium text-sm">
                        ...
                        <Link to="/login" className="text-orange-600 font-black hover:underline decoration-2 underline-offset-4">
                            Log in here
                        </Link>
                    </p>
                </motion.div>

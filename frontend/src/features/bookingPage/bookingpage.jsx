...
export const BookingPage = () => {
    ...
    const handleBooked = ()=>{
        localStorage.setItem('PersoanlDetails',JSON.stringify(bookingData));
    }
                ...
                <div className="lg:col-span-8 space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white p-8 rounded-[2.5rem] space-y-6 shadow-2xl">
                            ...
                            <InputField label="Aadhar Number" icon={<IdCard size={16}/>} placeholder="xxxxxxxxxxxx"  onChange={(v) => setBookingData({...bookingData, email: v})}/>
                        </div>
                        ...
                        <div className="bg-white p-8 rounded-[2.5rem] space-y-6 shadow-2xl">
                            ...
                            <div className="space-y-2">
                                ...
                                <input type="date" className="w-full bg-stone-50 border-2 border-stone-50 rounded-2xl p-4 focus:border-orange-500 focus:bg-white outline-none transition-all" />
                            </div>

    ...
    return (
        ...
        <div className="p-6">
          ...
          <nav className="space-y-1">
            ...
            <SideBarLink icon={Users} label="Tenants" active={activeTab === 'tenants'} onClick={() => setActiveTab('tenants')} />
            <SideBarLink icon={Wrench} label="Tickets" active={activeTab === 'tickets'} onClick={() => setActiveTab('tickets')} />
            <SideBarLink icon={FileText} label="Agreements" active={activeTab === 'agreements'} onClick={() => setActiveTab('agreements')} />
          </nav>
        </div>
      </aside>
    )

      ...
      <div className="max-w-8xl mx-auto relative">
        ...
        >
          ...
          <p className="text-slate-600 text-base md:text-lg leading-relaxed">
            We started with a simple goal: to eliminate the friction in PG living. By connecting owners and guests on a
            unified, transparent platform, we’ve built more than just a management tool—we’ve built a community rooted

      ...
      <div className="max-w-8xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <p className="text-lg text-slate-600 mt-8 leading-relaxed">
            A modern ecosystem designed to remove the friction between owners and residents. No more chasing rent or
            manual entries—everything you need is one click away.
          </p>

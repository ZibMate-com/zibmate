...
const RoleCard = ({ title, description, icon, color, onClick, delay }) => {
  ...
  return (
    ...
    >
      <div
        className={`size-16 rounded-2xl flex items-center justify-center transition-all duration-500 group-hover:rotate-6 mb-6 ${color === "orange" ? "bg-orange-50" : "bg-blue-50"}`}
      >
        {icon}
      </div>

...
export const Categories = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        ...
        const response = await fetch(`${baseUrl}/api/content/homepage_categories`);
        if (response.ok) {
  ...
  return (
    <section className="w-full p-6 md:p-10 mt-10">
      <h1 className="font-bold text-2xl md:text-4xl">Find Pg and hostel in Loaction away from home</h1>

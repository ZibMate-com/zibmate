            ...
            {faqData.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  <ChevronDown
                    className={`transition-transform duration-300 ${activeFaq === index ? "rotate-180 text-orange-500" : "text-gray-400"}`}
                  />
                </button>
                <AnimatePresence>
                  {activeFaq === index && (
              ...
              <div className="space-y-1">
                <label className="flex items-start gap-3 cursor-pointer group">
                  ...
                  <span className="text-sm text-gray-600 group-hover:text-gray-900 transition-colors">
                    I agree to the{" "}
                    <u className="text-orange-500 decoration-orange-200 hover:decoration-orange-500 transition-all">
                      privacy policy
                    </u>
                  </span>
                </label>

...
import { User, Phone, MapPin, ShieldCheck, ChevronRight, Zap, BarChart3, BellRing, Shield, CheckCircle2, X } from "lucide-react";
                        ...
                        >
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-slate-600 leading-relaxed mb-6">
                                    Thank you for choosing Zibmate. Our verification team will contact you shortly to set up your dashboard.
                                </p>
                                <button
                                    onClick={() => setIsSubmitted(false)}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-12 pr-4 h-14 rounded-2xl border-2 ${errors.fullName ? 'border-red-500' : 'border-slate-200'
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full px-4 h-14 rounded-2xl border-2 ${errors.email ? 'border-red-500' : 'border-slate-200'
                                        } focus:border-orange-500 focus:ring-4 focus:ring-orange-100 outline-none transition-all font-medium`}
                                />
                            </div>
                            {errors.email && (
                            ...
                            <div className="flex gap-2">
                                ...
                                <div className="relative flex-1">
                                    ...
                                    <input
                                        ...
                                        maxLength={10}
                                        className={`w-full pl-12 pr-4 h-14 rounded-2xl border-2 ${errors.phone ? 'border-red-500' : 'border-slate-200'
                                            } focus:border-orange-500 focus:ring-4 focus:ring-orange-100 outline-none transition-all font-medium`}
                                    />
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-12 pr-4 h-14 rounded-2xl border-2 ${errors.city ? 'border-red-500' : 'border-slate-200'
                                        } focus:border-orange-500 focus:ring-4 focus:ring-orange-100 outline-none transition-all font-medium`}
                                />
                            </div>
                            {errors.city && (
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={handleChange}
                                className={`w-full px-4 h-14 rounded-2xl border-2 ${errors.state ? 'border-red-500' : 'border-slate-200'
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className={`w-full h-14 font-bold rounded-2xl flex items-center justify-center gap-2 transition-all shadow-lg ${loading

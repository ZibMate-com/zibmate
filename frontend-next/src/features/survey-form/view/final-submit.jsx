            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <AnimatePresence mode="wait">
                <motion.span
                  ...
                  className={`text-xs font-black px-3 py-1 rounded-full ${formData.reviews.topPriorities.length > 0
              ...
              {priorityOptions.map((option) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`relative px-2 py-3 rounded-2xl border-2 cursor-pointer transition-all duration-200 ${isSelected
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={`w-6 h-6 rounded-lg border-2 flex items-center justify-center transition-colors ${isSelected ? "bg-orange-500 border-orange-500" : "border-gray-200"
                        }`}>
                        {isSelected && (
                          <motion.svg
                            initial={{ scale: 0 }}

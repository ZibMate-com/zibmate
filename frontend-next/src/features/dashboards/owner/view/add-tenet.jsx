...
export const AddTenantModal = ({ isOpen, onClose, onAdd }) => {
  const [formData, setFormData] = useState({
    name: '', email: '', phone: '',
    gender: '', nationality: '', floorNo: '', roomNo: ''
  });
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="px-10 pt-10 pb-6 flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-3xl font-black text-slate-900 tracking-tight">Onboard <span className="text-orange-500">Tenant</span></h3>
                  <p className="text-slate-500 text-sm mt-1">Fill in the details to generate the digital agreement.</p>
                </div>
                <button type="button" onClick={onClose} className="p-3 bg-slate-50 hover:bg-slate-100 text-slate-400 hover:text-slate-900 rounded-2xl transition-all">
                  <X size={20} />
                </button>
              </div>
              ...
              <div className="px-10 pb-10 space-y-8">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="md:col-span-2 relative group">
                      ...
                      <input required name="name" onChange={handleChange} placeholder="Full Legal Name" className={inputBase} />
                    </div>
                    ...
                    <div className="relative group">
                      ...
                      <input required type="email" name="email" onChange={handleChange} placeholder="Email Address" className={inputBase} />
                    </div>
                    ...
                    <div className="relative group">
                      ...
                      <input required type="tel" name="phone" onChange={handleChange} placeholder="Phone Number" className={inputBase} />
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="relative group">
                      ...
                      <input name="nationality" onChange={handleChange} placeholder="Nationality" className={inputBase} />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="size-6 rounded-full bg-slate-900 text-white text-[10px] flex items-center justify-center font-bold">3</div>
                    ...
                    <div className="flex gap-3">
                      <div className="relative group flex-1">
                        ...
                        <input required type="number" name="floorNo" onChange={handleChange} placeholder="Floor" className={inputBase} />
                      </div>
                      <div className="relative group flex-1">
                        ...
                        <input required type="text" name="roomNo" onChange={handleChange} placeholder="Room" className={inputBase} />
                      </div>
                    </div>
                ...
                <div className="flex items-center gap-4 pt-4">
                  <button type="button" onClick={onClose} className="flex-1 py-4 text-slate-500 font-bold rounded-2xl hover:bg-slate-50 transition-all active:scale-95">
                    Discard
                  </button>
                  <button type="submit" className="flex-[2] flex items-center justify-center gap-2 py-4 bg-slate-900 text-white font-bold rounded-2xl hover:bg-orange-600 transition-all shadow-xl shadow-slate-200 active:scale-95">

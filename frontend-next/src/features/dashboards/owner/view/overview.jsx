  ...
  return (
    <main className="flex-1 p-6 lg:p-10 max-w-7xl mx-auto w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <StatCard label="Total Revenue" value={`₹${stats.totalRevenue.toLocaleString()}`} sub="Current confirmed earnings" />
        <StatCard label="Total Bookings" value={stats.totalBookings.toString()} sub="Total stay requests" />
        <StatCard label="Active Tickets" value={stats.activeTickets.toString()} sub="Needs attention" isAlert={stats.activeTickets > 0} />
            ...
            <div className="p-6 border-b border-gray-50 flex justify-between items-center">
              ...
              <div className="flex gap-2">
                <div className="relative">
                  ...
                  <input type="text" placeholder="Search name..." className="pl-9 pr-4 py-2 bg-slate-50 border-none rounded-xl text-xs focus:ring-2 ring-orange-500/20 outline-none w-48" />
                </div>
              ...
              <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-gray-50">
                  {tenants.length > 0 ? tenants.map((tenant) => (
                    ...
                    <tr>
                      <td colSpan="4" className="px-6 py-10 text-center text-slate-400">No active tenants yet.</td>
                    </tr>
                  )}
                </tbody>
              </table>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-6">
            <div className="flex justify-between items-center mb-6">
              ...
              <span className="bg-orange-100 text-orange-600 text-[10px] font-black px-2 py-1 rounded-md">{tickets.length} OPEN</span>
            </div>

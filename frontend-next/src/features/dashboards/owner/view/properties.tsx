                                ...
                                <div className="flex flex-col text-gray-700 gap-1">
                                    ...
                                    <div className="flex items-center gap-6 mt-2">
                                        <div className="flex flex-wrap gap-2 mt-2">
                                            {prop.Occupancy && (Array.isArray(prop.Occupancy) ? prop.Occupancy : JSON.parse(prop.Occupancy || '[]')).map((o: any, i: number) => (
                                    ...
                                    <div className="flex flex-wrap gap-2 mt-2">
                                        {prop.facilities && (Array.isArray(prop.facilities) ? prop.facilities : JSON.parse(prop.facilities || '[]')).map((f: any, i: number) => (

        ...
        <div className="flex flex-col gap-8 mt-5">
            {
                requests.map((req) => {
                    return (
                        <div key={req.id} className="flex text-lg shadow-sm hover:shadow-md transition items-center rounded-[2rem] p-4 bg-white border border-slate-100">
                            ...
                            <div className="flex justify-between items-center p-3 w-full gap-6">
                                <div className="flex flex-col text-slate-700">
                                    ...
                                    <div className="flex gap-4 mt-2 text-xs text-slate-400 font-medium">
                                        ...
                                        <span className={`uppercase font-black ${req.status === 'confirmed' ? 'text-emerald-500' : 'text-orange-500'}`}>
                                            Status: {req.status}
                                        </span>
                                    </div>
                                </div>

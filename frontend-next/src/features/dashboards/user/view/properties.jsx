        ...
        <div className=" flex flex-col gap-10 mt-5">
            {
                properties.map((prop) => {
                    return (
                        <div key={prop.id} className="group flex flex-col md:flex-row gap-6 p-4 bg-white border border-stone-100 rounded-[2rem] shadow-sm hover:shadow-xl hover:shadow-orange-900/5 transition-all duration-500">

                            {/* 1. Image Section - Fixed Aspect Ratio */}
                            <div className="w-full md:w-72 h-56 shrink-0 overflow-hidden rounded-[1.5rem] relative">
                                <img
                                    src={prop.images?.[0] || "https://images.unsplash.com/photo-1580587771525-78b9dba3b914?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}
                                ...
                                <div className="flex flex-row lg:flex-col justify-between items-end lg:w-48 border-t lg:border-t-0 lg:border-l border-stone-50 pt-4 lg:pt-0 lg:pl-6">
                                    ...
                                    <div className="flex flex-col gap-2 w-full max-w-[120px]">
                                        ...
                                        <div className="flex items-center justify-center gap-1.5">
                                            <div className={`size-1.5 rounded-full animate-pulse ${prop.status === 'active' ? 'bg-emerald-500' : 'bg-red-500'}`} />

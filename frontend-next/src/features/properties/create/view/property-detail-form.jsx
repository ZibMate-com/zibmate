    ...
    <div className="flex justify-center items-center min-h-[calc(100vh-80px)] md:p-6 bg-slate-50/50 font-Montserrat">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl font-black text-slate-900 tracking-tight">Listing Details</h2>
          <p className="text-slate-500 font-medium mt-2">Upload photos and set pricing for your PG.</p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="space-y-1.5">
              ...
              />
              {errors.propertyName && (
                <p className="text-rose-500 text-[10px] font-bold mt-1 ml-2">{errors.propertyName}</p>
              )}
            </div>
            <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="space-y-1.5">
              ...
              />
              {errors.houseNumber && (
                <p className="text-rose-500 text-[10px] font-bold mt-1 ml-2">{errors.houseNumber}</p>
              )}
            </div>
            <div className="space-y-1.5">
